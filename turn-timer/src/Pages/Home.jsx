    ...
    <div className="home">
      <div className="grid-container">
          ...
          <header className="App-header">
            <button className="btn btn-dark">
              <Link class="nav-link" to="/DieRoller">
                <h4>Die Roller</h4>
                <img src={dragonDieLink} id="die roller" className="App_logo" alt="logo" />
        ...
        <div className="item2">
          <button className="btn btn-dark">
            <Link class="nav-link" to="/TurnTimer">
              <h4>Turn Timer</h4>
              <header className="App-header">
                <img src={hourglassLink} id="turn tracker" className="App_logo" alt="logo" />
                <span class="sr-only">(current)</span>
              </header>
            </Link>
          </button>
        ...
        <div className="item3">
          ...
          <header className="App-header">
            <img src={spellbookLink} id="spells and weapons" className="App_logo" alt="logo" />
            <span class="sr-only">(current)</span>
          </header>
          </button>
        </div>
        ...
        <div className="item4">
          ...
          <h4>Die Roller</h4>
          <header className="App-header">
            <img src={monsterLink} id="die roller" className="App_logo" alt="logo" />
          </header>
          </button>
        </div>
      </div>
